...
require([
    ...
    'modernizr',
    'app',
    'routers/specificproducts'
    ],
    function(_, Backbone,$, jqueryui,jqueryscrollto,bxslider,jquerytouchSwipe,bootstrap,buttons,utilityshared,multiselect,jqueryform,Modernizr,app,specificproducts){
	    app.init(specificproducts);
	});
