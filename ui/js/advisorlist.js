...
require([
    ...
    function(_, Backbone,$, jqueryui,jqueryscrollto,bootstrap,carousel,bxslider,jmultiselect,jquerytouchSwipe,utilityshared,Modernizr,app,advisorlist){
        app.init(advisorlist);
    });
