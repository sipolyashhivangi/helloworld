define([
    ...
    var Router = Backbone.Router.extend({
        ...
        initialize: function() {
            userData = null;
            var postUrl = 'jobs';
            var categoryUrl = 'jobcategory';
            var searchUrl = 'jobsearch';
            ...
            if (params["type"] == "jobs" && typeof(params["id"]) != 'undefined' && params["id"] != '')
            {
                require(
                        ['views/job/post'],
                        function(postView) {
            ...
            else if (params["type"] == "jobsearch" && typeof(params["id"]) != 'undefined' && params["id"] != "")
            {
                require(
                        ['views/job/searchresult', 'views/job/post'],
            ...
            else if (params["type"] == "jobcategory" && typeof(params["id"]) != 'undefined' && params["id"] != '')
            {
                require(
                        ['views/job/searchresult', 'views/job/post'],
