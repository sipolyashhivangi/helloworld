...
require([
    ...
    'modernizr',
    'app',
    'routers/advisorverify'
    ],
    function(_, Backbone,$, jqueryui,jqueryscrollto,bootstrap,bxslider,jquerytouchSwipe,utilityshared,Modernizr,app,advisorverify){        
		app.init(advisorverify);
    });
