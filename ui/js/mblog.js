...
require([
    ...
    'routers/blog'
        ...
        function(_, Backbone, $, jqueryui, jqueryscrollto, bootstrap, bxslider, jquerytouchSwipe, utilityshared, multiselect, jqueryform, Modernizr, jquerycaroufredsel, app, blog) {
            app.init(blog);
        });