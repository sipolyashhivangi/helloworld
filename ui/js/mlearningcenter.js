...
require([
    ...
    'jquerycaroufredsel',
    'app',
    'routers/learningcenter'
    ],
    function(_, Backbone,$, jqueryui,jqueryscrollto,bootstrap,bxslider,jquerytouchSwipe,utilityshared,multiselect,jqueryform,Modernizr,jquerycaroufredsel,app,learningcenter){
        app.init(learningcenter);
    });