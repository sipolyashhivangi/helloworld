...
require([
    ...
    function(_, Backbone,$, jqueryui,jqueryscrollto,bootstrap,bxslider,jquerytouchSwipe,utilityshared,multiselect,jqueryform,Modernizr,jquerycaroufredsel,app,release){
        app.init(release);
    });
