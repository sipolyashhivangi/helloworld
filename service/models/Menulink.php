...
/**
 * This is the model class for table "menulink".
 *
 * The followings are the available columns in table 'menulink':
 ...
 */
class Menulink extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Menulink the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Menulink', array(
			'criteria'=>$criteria,
		));
	}
}