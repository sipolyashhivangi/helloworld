    ...
    function send($data, $timeout = 0, $response_timeout = 30, $cookies = NULL) {
        ...
        while ($this->tryagain) {
            ...
            if ($tries++ < 2) {
                ...
                Yii::trace(":Request:" . html_entity_decode($data), "calcxmlcategory");
                Yii::trace(":Response:" . html_entity_decode($respdata), "calcxmlcategory");
                
            } else {
                $this->setError("Too many tries to get an OK response ($this->response_status_line)");
                Yii::trace(":Error:" . $this->response_status_line);
            }
        }
