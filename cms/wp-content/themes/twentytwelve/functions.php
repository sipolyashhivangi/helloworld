...
if (!function_exists('twentytwelve_comment')) :
    ...
    function create_post_type() {
        ...
        $press = array(
            ...
            'public' => true,
            'menu_position' => 5,
            'rewrite' => array('slug' => 'type_press'),
            'supports' => array('title','editor','author','thumbnail','excerpt')
        );
        register_post_type('type_press',$press);
        $blog = array(
            'labels' => array(
                'name' => __('Blog'),
            ...
            'public' => true,
            'menu_position' => 5,
            'rewrite' => array('slug' => 'type_blog'),
            'supports' => array('title','editor','author','thumbnail','excerpt')
        );
        register_post_type('type_blog',$blog);
        $job = array(
            'labels' => array(
                'name' => __('Job'),
            ...
            'public' => true,
            'menu_position' => 5,
            'rewrite' => array('slug' => 'type_job'),
            'supports' => array('title','editor','author','thumbnail','excerpt')
        );
        register_post_type('type_job',$job);
    }
