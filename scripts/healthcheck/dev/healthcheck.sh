...
# Dev Configs - checkk contains the count of actionstep instances currently running
...
# Dev Configs - checkm contains the count of monte carlo instances currently running
...
# Dev Configs - checkpy contains the PIDs for the mail instances.
...
then
        sudo kill -9 $checkpy
        nohup /usr/bin/python /var/www/dev/scripts/python-mail/getmailandsend.py > /dev/null 2>&1 &
        nohup /usr/bin/python /var/www/test/scripts/python-mail/getmailandsend.py > /dev/null 2>&1 &
